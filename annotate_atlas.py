...
from report_utils import draw_bold_text_centered
...
def annotate_atlas_pair(screening_root, atlas_root):
    ...
    # Fonts
    font_labels = pil_font(FONT_SIZES["caption"], bold=True)
    ...
    if scale_bar_px is not None:
        ...
        y_bar_bottom = y_leg_top + legend_item_height + 3
        final_draw.rectangle(
        ...
        label_y = y_bar_bottom - scale_bar_height_px - 8
